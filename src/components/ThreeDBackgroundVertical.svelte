<script>
    ...
    class FloatingObject {
        ...
        constructor(speedX, speedY, maxX, maxY, spawnX, spawnY, object, zIndex) {
            ...
            this.speedY = Math.random() * (speedY - (speedY - 5)) + (speedY - 5);;
            this.maxX = maxX;
            this.maxY = maxY;;
            this.spawnX = spawnX;
            this.spawnY = spawnY;
            ...
            this.object.position.x = Math.random() * (this.spawnX + this.spawnX ) - this.spawnX;
            this.object.position.y = Math.random() * (this.spawnY - (this.spawnY - 30)) + (this.spawnY - 30);
    ...
    onMount(() => {
        ...
        loader.load('/models/bunny.obj', (/** @type {{ clone: () => any; }} */ model) => {
            for (let i = 0; i < objectCount; i++) {
                ...
                bunnies[i] = new FloatingObject(0.05,6,40,20,33,-20,bunny,0 + i * 5);
        ...
        loader.load('/models/heart.obj', (/** @type {{ clone: () => any; }} */ model) => {
            for (let i = 0; i < objectCount; i++) {
                ...
                hearts[i] = new FloatingObject(0.05,6,40,20,33,-20,heart,100 + i * 5);
        ...
        loader.load('/models/star.obj', (/** @type {{ clone: () => any; }} */ model) => {
            for (let i = 0; i < objectCount; i++) {
                ...
                stars[i] = new FloatingObject(0.05,6,40,20,33,-20,star,200 + i * 5);
